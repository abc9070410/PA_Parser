...
function initCheckList()
{
    ...
    gaaFISCheck[CHECK_LOGO][CHECK_LPM_IDX_4] = "IPM-01 IPM-09";
    gaaFISCheck[CHECK_TEXT][CHECK_LPM_IDX_5] = "Device 收到 COMWAKE 後 , 需 10 ms 內離開 slumber state "; // IPM-02, IPM-10
    gaaFISCheck[CHECK_LOGO][CHECK_LPM_IDX_5] = "IPM-02 IPM-10";
    ...
    gaaFISCheck[CHECK_LOGO][CHECK_LPM_IDX_6] = "IPM-03 IPM-11";
    ...
    gaaFISCheck[CHECK_LOGO][CHECK_LPM_IDX_7] = "IPM-04 IPM-05";
    ...
    gaaFISCheck[CHECK_LOGO][CHECK_OOB_IDX_0] = "ASR-01";
    gaaFISCheck[CHECK_TEXT][CHECK_OOB_IDX_1] = "連線成功之前 , device 送出每個 COMINIT 的間隔時間需大於等於 10ms"; // ASR-02
    gaaFISCheck[CHECK_LOGO][CHECK_OOB_IDX_1] = "ASR-02";
    ...
    gaaFISCheck[CHECK_LOGO][CHECK_NON_NCQ_ERR_HANDLE_IDX_6] = "GTR-05";
