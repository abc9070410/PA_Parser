...
var FIS_CHECK_DATA_FIS_BASE = ["DATA FIS相關", 20];
var FIS_CHECK_LPM_BASE = ["LPM相關",30];
var FIS_CHECK_LOGO_BASE = ["SATA LOGO相關",40];
var FIS_CHECK_NCQ_ERR_HANDLE_BASE = ["NCQ ERR HNADLE相關",50];
var FIS_CHECK_NON_NCQ_ERR_HANDLE_BASE = ["NON-NCQ ERR HNADLE相關",60];
var FIS_CHECK_OTHER_BASE = ["其他相關",70];
var FIS_CHECK_END_BASE = 80;
...
var CHECK_D2H_IDX_0 = FIS_CHECK_D2H_FIS_BASE[1] + 0;
var CHECK_D2H_IDX_1 = FIS_CHECK_D2H_FIS_BASE[1] + 1;
var CHECK_D2H_IDX_2 = FIS_CHECK_D2H_FIS_BASE[1] + 2;
var CHECK_D2H_IDX_3 = FIS_CHECK_D2H_FIS_BASE[1] + 3;
var CHECK_D2H_IDX_4 = FIS_CHECK_D2H_FIS_BASE[1] + 4;

var CHECK_DATA_IDX_0 = FIS_CHECK_DATA_FIS_BASE[1] + 0;
var CHECK_DATA_IDX_1 = FIS_CHECK_DATA_FIS_BASE[1] + 1;
var CHECK_DATA_IDX_2 = FIS_CHECK_DATA_FIS_BASE[1] + 2;
var CHECK_DATA_IDX_3 = FIS_CHECK_DATA_FIS_BASE[1] + 3;
var CHECK_DATA_IDX_4 = FIS_CHECK_DATA_FIS_BASE[1] + 4;
...
var CHECK_LOGO_IDX_0 = FIS_CHECK_LOGO_BASE[1] + 0;
var CHECK_LOGO_IDX_1 = FIS_CHECK_LOGO_BASE[1] + 1;
var CHECK_LOGO_IDX_2 = FIS_CHECK_LOGO_BASE[1] + 2;
var CHECK_LOGO_IDX_3 = FIS_CHECK_LOGO_BASE[1] + 3;
var CHECK_LOGO_IDX_4 = FIS_CHECK_LOGO_BASE[1] + 4;
var CHECK_LOGO_IDX_5 = FIS_CHECK_LOGO_BASE[1] + 5;
var CHECK_LOGO_IDX_6 = FIS_CHECK_LOGO_BASE[1] + 6;
var CHECK_LOGO_IDX_7 = FIS_CHECK_LOGO_BASE[1] + 7;
var CHECK_LOGO_IDX_8 = FIS_CHECK_LOGO_BASE[1] + 8;
var CHECK_LOGO_IDX_9 = FIS_CHECK_LOGO_BASE[1] + 9;
...
var CHECK_NCQ_ERR_HANDLE_IDX_6 = FIS_CHECK_NCQ_ERR_HANDLE_BASE[1] + 5;
var CHECK_NCQ_ERR_HANDLE_IDX_5 = FIS_CHECK_NCQ_ERR_HANDLE_BASE[1] + 6;
...
var CHECK_NON_NCQ_ERR_HANDLE_IDX_6 = FIS_CHECK_NON_NCQ_ERR_HANDLE_BASE[1] + 5;
var CHECK_NON_NCQ_ERR_HANDLE_IDX_5 = FIS_CHECK_NON_NCQ_ERR_HANDLE_BASE[1] + 6;
